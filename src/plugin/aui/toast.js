...
auiToast.prototype = {
    create: function(params,callback) {
        ...
        if(document.querySelector(".aui-toast")) document.querySelector(".aui-toast").innerHTML = iconHtml+titleHtml;
        else document.body.insertAdjacentHTML('beforeend', toastHtml);
    ...
    show: function(){
        ...
        setTimeout(function(){
            document.querySelector(".aui-toast").classList.add("aui-toast-in");
        }, 10)
        if(document.querySelector(".aui-toast"))return;
    },
    hide: function(){
        var self = this;
        document.querySelector(".aui-toast").classList.add("aui-toast-out");
        setTimeout(function(){
    ...
    updateTitle:function(title){
      document.querySelector(".aui-toast-content").innerText = title;
    }
};
