...
const subpageStyleXiaoyuan = { top: '0px', titleNView: { backgroundColor: '#FFff00', titleText: '校园', titleColor: '#CCCCCC' } }
const subpageStyleBanji = { top: '0px', titleNView: { backgroundColor: '#540000', titleText: '班级', titleColor: '#CCCCCC' } }
const subpageStyleBamaquan = { top: '0px', titleNView: { backgroundColor: '#668800', titleText: '爸妈圈', titleColor: '#CCCCCC' } }
const subpageStyleMore = { top: '0px', titleNView: { backgroundColor: '#aacc00', titleText: '更多', titleColor: '#CCCCCC' } }
