...
const clickButtonStudents = (): void => {
  $.noop()
}
const clickButtonParents = (): void => {
  $.noop()
}
const subpageStyleBanji = { top: '0px', backButtonAutoControl: 'none', titleNView: { backgroundColor: '#880033', titleText: '启蒙一班', titleColor: '#CCCCCC', buttons: [
  { text: '学生', fontSize: '14px', float: 'left', onclick: clickButtonStudents },
  { text: '家长', fontSize: '14px', float: 'right', onclick: clickButtonParents }
] } }
